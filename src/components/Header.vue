<template>
  <div
    v-if="!visibilityChecks?.isResponsiveHeaderVisible"
    class="header"
    @click="closeAllPopup"
  >
        ...
        <div class="top-section__content__main-menu-section">
          <div class="search-section">
            <div
              :class="{
                'input-wrapper': true,
                'wrapper-outline': visibilityChecks?.isWrapperOutlineVisible,
              }"
            >
              <input
                :class="{
          ...
          <div class="lang-select">
            ...
            >
              <img
                ...
                alt="globe-icon"
                class="lang-select__button--globe"
              />
          ...
          <div class="options-toggle">
            <button
              :class="{
                'header-btn': true,
                'options-toggle__button': true,
                'temp-options-btn-outline':
                  visibilityChecks?.isHamburgerOutlineVisible,
              }"
    ...
    <div
      v-if="visibilityChecks?.isExpandableMenuVisible"
    ...
    <div
      v-if="visibilityChecks?.isExpandableTopicsMenuVisible"
    ...
    >
      <div class="topics-menu__content">
        <div class="topics-menu-navs">
          <nav
            v-for="topicNav in headerTopicsData"
            :key="topicNav.id"
          ...
          >
            ...
            <button
              v-for="(navItem, index) in topicNav.details"
              :key="index"
    ...
    <div class="main-nav">
      <div class="header-contents-container main-nav__content">
        ...
        >
          ...
          <div
            v-if="visibilityChecks?.isMoreForecastsOptionVisible"
  ...
  <div v-else class="responsive-header">
    <div
      :class="{
        'responsive-header__content': true,
        'responsive-content-change':
          visibilityChecks?.isResponsiveDropDownVisible,
      }"
    >
      <a class="company-logo-1">
        <img
          class="company-logo-1__img"
          src="../images/logo-header.svg"
          alt="responsive-header-company-icon"
        />
      </a>
      <a
        :class="{
          'company-logo-2': true,
          'change-visibility': visibilityChecks?.isResponsiveDropDownVisible,
        }"
      >
        <img
          src="../images/toi-logo.png"
          alt="responsive-header-company-icon-2"
          class="company-logo-2__img"
        />
      </a>

      <div
        :class="{
          'responsive-search': true,
          'change-visibility': visibilityChecks?.isResponsiveDropDownVisible,
        }"
      >
        <button class="responsive-search__button">
          <h1 class="responsive-search__button__heading">
            {{ headerData?.currentWeatherDetails?.city }},
            {{ headerData?.currentWeatherDetails?.state }} Weather
          </h1>
          <img
            class="responsive-search__button__icon"
            src="../images/search-icon.svg"
      ...
      <div @click.stop="onToggleDropDownView" class="responsive-bars-icon">
        <img
          v-if="!visibilityChecks?.isResponsiveDropDownVisible"
          class="responsive-bars-icon__image"
          src="../images/menu-responsive.svg"
          alt="responsive-header-icon"
        />
        <img
          v-else
          class="responsive-bars-icon__image"
          src="../images/responsive-close-icon.svg"
          alt="responsive-header-icon"
        />
      </div>
    </div>
...
const onToggleTopicsMenu = () => {
  ...
  visibilityChecks.value.isHamburgerOutlineVisible = true;
};
...
const closeAllPopup = () => {
  ...
  visibilityChecks.value.isHamburgerOutlineVisible = false;
};
...
const onResponsive = () => {
  ...
  if (
    ...
    visibilityChecks.value?.isResponsiveDropDownVisible
  ) {
    visibilityChecks.value.isResponsiveDropDownVisible = false;
    emits(
      "toggleElementsVisbility",
      visibilityChecks.value.isResponsiveDropDownVisible
    );
  }
};
